...
const defaultOwner = '2250151757363';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '2250151757363';  // put your number here
...
//
global.botname = process.env.BOTNAME || 'kira-MD';
global.pairingNumber = process.env.BOT_NUMBER || '2250151757363';  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'session id';  // put your session id here

global.mods = []
global.prems = []
global.allowed = ['2250151757363', '923051391007']
